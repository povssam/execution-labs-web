          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
            {process.map((step, i) => (
              <Reveal key={step.index} delay={i * 0.06}>
                <div className="group">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border border-line bg-ink font-mono text-sm text-bone transition-colors duration-200 group-hover:border-bone/40">
                    {step.index}
                  </div>
