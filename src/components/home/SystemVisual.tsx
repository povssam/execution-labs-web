...
const geometries: Record<SystemVisualVariant, Geometry> = {
  ...
  proof: {
    paths: [
      "M170 450 C170 245 360 145 585 145 C850 145 1030 280 1030 450 C1030 655 850 755 585 755 C335 755 170 635 170 450",
      "M365 450 C365 335 465 285 585 285 C725 285 835 350 835 450 C835 565 725 615 585 615 C455 615 365 555 365 450",
    ],
    nodes: [[170,450,12,"quiet"],[585,145,10,"quiet"],[1030,450,16,"accent"],[585,755,10,"quiet"],[365,450,10,"quiet"],[585,285,10,"accent"],[835,450,16,"core"],[585,615,10,"quiet"]],
    rings: [[600,450,76,76]],
  },
  "orbit-artist-group": {
    paths: [
